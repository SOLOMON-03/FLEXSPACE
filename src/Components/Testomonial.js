...
const Testomonial = () => {
    return (
        <div className="flex items-center justify-center flex-col h-[800px] bg-[#6c34af]">
            <h1 className="text-6xl font-bold text-white my-5 max-[376px]:text-xl">Our Testomonial</h1>
            <Swiper
                breakpoints={{
                    "@0.00": {
                        slidesPerView: 2,
            ...
            >
                {Worker.map((item) => (
                    <SwiperSlide key={item.name}>
                        <div className="flex flex-col gap-6 mb-20 group relative shadow-lg text-white rounded-xl px-6 py-8 h-[450px] w-[280px] lg:h-[550px] lg:w-[350px] overflow-hidden cursor-pointer">
